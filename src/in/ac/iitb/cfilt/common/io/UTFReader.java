...
/**
 * Class : Reader Purpose : This class handles all file input operations.
 */
public class UTFReader {
    ...
    /**
     * Method : open Purpose : Opens a handle to the file .
     */
    public void open() throws IOException {
        this.objBufReader = new BufferedReader(new InputStreamReader(new FileInputStream(objFile), encoding), 4096);

    }

    /**
     * Method : readLine Purpose : Reads a Line from the file .
     * @param - String
     */
    ...
    /**
     * Method : close Purpose : Closes the handle to the file .
     */
    public void close() {
        try {
            if (this.objBufReader != null) {
